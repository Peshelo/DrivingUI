<template>
  ...
  <div>
    ...
    <div class="flex justify-between mx-5 mt-10">
      <div class="mb-4">
        <label for="nationalIDFilter" class="block font-medium mb-1"
          >Filter by national ID:</label
        >
        <input
          v-model="nationalIDFilter" id="nationalIDFilter" type="text" class="border border-gray-300 rounded-md px-4 py-1 w-full" placeholder="Search by national ID"
        />
      </div>
      <div>
        <!-- Add Button -->
        ...
        <!-- Modal -->
        <div v-if="addModal" class="z-10 pt-24 absolute inset-0 top-0 h-screen w-screen backdrop-brightness-50 flex items-center justify-center" >
